general idea is a full blown desktop environment with a feature rich compostor builtin.
replaces icewm, hyperland, sway, awesomewm, xmonad, xfce4, etc.
builtin virtual desktops with custom naming.
yaml based config file and also a full featured settings ui(similiar to xfce4-setting).
full wayland(not xwayland but native) and x11 fully supported.
take all of the features from all of the desktop environment(deduplicated).
